...
public  class LIB_Author extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeString nameAuthor;    
    ...
    public LIB_Author() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("LIB_Author");
        ...
        atts.add(nameAuthor = new netgest.bo.runtime.attributes.boAttributeString(this,"nameAuthor"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( nameAuthor.haveDefaultValue()) 
                {
                	if(nameAuthor.defaultValue() != null)
                	{
                    	nameAuthor._setValue(boConvertUtils.convertToString(nameAuthor.defaultValue(), nameAuthor));
                    }
                    else
                    {
                    	nameAuthor._setValue(null);
                    }
                    nameAuthor.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("LIB_Author".equals(this.getName()))
            {
