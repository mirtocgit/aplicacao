...
public  class Ebo_LOV extends boObject implements  Serializable {  
    ...
    public netgest.bo.runtime.attributes.boAttributeString xeolovfile;    
    ...
    public Ebo_LOV() {
        ...
        atts.add(xeolovfile = new netgest.bo.runtime.attributes.boAttributeString(this,"xeolovfile"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( xeolovfile.haveDefaultValue()) 
                {
                	if(xeolovfile.defaultValue() != null)
                	{
                    	xeolovfile._setValue(boConvertUtils.convertToString(xeolovfile.defaultValue(), xeolovfile));
                    }
                    else
                    {
                    	xeolovfile._setValue(null);
                    }
                    xeolovfile.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
