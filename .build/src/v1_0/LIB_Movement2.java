...
public  class LIB_Movement2 extends boObject implements  Serializable {  
    ...
    public netgest.bo.runtime.attributes.boAttributeObject books;    
    ...
    public LIB_Movement2() {
        super();
        bo_version      = "1.0";
        bo_name         = "LIB_Movement2";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("LIB_Movement2");
        ...
        atts.add(books = new netgest.bo.runtime.attributes.boAttributeObject(this,"books"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( books.haveDefaultValue()) 
                {
                	...
                	{
                    	books._setValue(boConvertUtils.convertToBigDecimal(books.defaultValue(), books));
                    }
                    else
                    {
            ...
            if("LIB_Movement2".equals(this.getName()))
            {
