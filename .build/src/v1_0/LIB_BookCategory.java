...
public  class LIB_BookCategory extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeString nameB;    
    ...
    public LIB_BookCategory() {
        super();
        bo_version      = "1.0";
        bo_name         = "LIB_BookCategory";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("LIB_BookCategory");
        ...
        atts.add(nameB = new netgest.bo.runtime.attributes.boAttributeString(this,"nameB"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( nameB.haveDefaultValue()) 
                {
                	if(nameB.defaultValue() != null)
                	{
                    	nameB._setValue(boConvertUtils.convertToString(nameB.defaultValue(), nameB));
                    }
                    else
                    {
                    	nameB._setValue(null);
                    }
                    nameB.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("LIB_BookCategory".equals(this.getName()))
            {
