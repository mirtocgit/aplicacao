...
public  class uiWorkPlace extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeString defaultViewer;    
    ...
    public uiWorkPlace() {
        ...
        atts.add(defaultViewer = new netgest.bo.runtime.attributes.boAttributeString(this,"defaultViewer"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( defaultViewer.haveDefaultValue()) 
                {
                	if(defaultViewer.defaultValue() != null)
                	{
                    	defaultViewer._setValue(boConvertUtils.convertToString(defaultViewer.defaultValue(), defaultViewer));
                    }
                    else
                    {
                    	defaultViewer._setValue(null);
                    }
                    defaultViewer.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
    ...
    public bridgeHandler getBridge( String bridgeName ) 
    {
        ...
        if( ret == null )
        {
        	...
        	{
            	brig.add( ret=new BridgeHandlerprofiles(new DataResultSet( getBridgeDataSet("profiles") ) , this ) );        
        	}
        	if( ret == null )
        	{
