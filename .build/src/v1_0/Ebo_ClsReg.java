...
public  class Ebo_ClsReg extends boObject implements  Serializable {  
    ...
    public bridgeHandler getBridge( String bridgeName ) 
    {
        ...
        if( ret == null )
        {
        	...
        	{
            	brig.add( ret=new BridgeHandlersecurity(new DataResultSet( getBridgeDataSet("security") ) , this ) );        
        	}
        	if( bridgeName.equals("attributes") && (ret=brig.get("attributes"))==null )
        	{
            	brig.add( ret=new BridgeHandlerattributes(new DataResultSet( getBridgeDataSet("attributes") ) , this ) );        
        	}
        	if( bridgeName.equals("methods") && (ret=brig.get("methods"))==null )
        	{
            	brig.add( ret=new BridgeHandlermethods(new DataResultSet( getBridgeDataSet("methods") ) , this ) );        
        	}
        	if( ret == null )
        	{
