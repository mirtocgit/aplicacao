...
public  class XeoApplicationLanguage extends boObject implements  Serializable {  
    ...
    public XeoApplicationLanguage() {
        super();
        bo_version      = "1.0";
        bo_name         = "XeoApplicationLanguage";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("XeoApplicationLanguage");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("XeoApplicationLanguage".equals(this.getName()))
            {
