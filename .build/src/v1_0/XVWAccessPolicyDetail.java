...
public  class XVWAccessPolicyDetail extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeObject object;    
    public netgest.bo.runtime.attributes.boAttributeNumber accessLevel;    
    ...
    public XVWAccessPolicyDetail() {
        super();
        bo_version      = "1.0";
        bo_name         = "XVWAccessPolicyDetail";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("XVWAccessPolicyDetail");
        ...
        atts.add(accessLevel = new netgest.bo.runtime.attributes.boAttributeNumber(this,"accessLevel"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( accessLevel.haveDefaultValue()) 
                {
                	if(accessLevel.defaultValue() != null)
                	{
                    	accessLevel._setValue(boConvertUtils.convertToBigDecimal(accessLevel.defaultValue(), accessLevel));
                    }
                    else
                    {
                    	accessLevel._setValue(null);
                    }
                    accessLevel.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("XVWAccessPolicyDetail".equals(this.getName()))
            {
