...
public  class LIB_PublisherNucleus extends boObject implements  Serializable {  
    ...
    public LIB_PublisherNucleus() {
        super();
        bo_version      = "1.0";
        bo_name         = "LIB_PublisherNucleus";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("LIB_PublisherNucleus");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("LIB_PublisherNucleus".equals(this.getName()))
            {
