...
public  class Ebo_FavoriteViewer extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeObject targetBouiObj;    
    ...
    public Ebo_FavoriteViewer() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_FavoriteViewer";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_FavoriteViewer");
        ...
        atts.add(targetBouiObj = new netgest.bo.runtime.attributes.boAttributeObject(this,"targetBouiObj"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( targetBouiObj.haveDefaultValue()) 
                {
                	if(targetBouiObj.defaultValue() != null)
                	{
                    	targetBouiObj._setValue(boConvertUtils.convertToBigDecimal(targetBouiObj.defaultValue(), targetBouiObj));
                    }
                    else
                    {
                    	targetBouiObj._setValue(null);
                    }
                    targetBouiObj.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("Ebo_FavoriteViewer".equals(this.getName()))
            {
...
return new String[] {"targetBouiObj"} ;
}
